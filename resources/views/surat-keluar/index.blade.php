        ...
        <div class="card-body">
            <form method="GET" action="{{ route('surat-keluar.index') }}">
                ...
                <div class="mt-3">
                    ...
                    <a href="{{ route('surat-keluar.index') }}" class="btn btn-link">Reset</a>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-vcenter table-striped table-hover card-table">
                <thead>
                    <tr>
                        <th>
                            <a href="{{ route('surat-keluar.index', array_merge(request()->all(), ['sort' => 'nomor_surat', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}" class="text-secondary">
                                Nomor Surat
                        ...
                        <td colspan="7" class="text-center py-5">
                            <div class="empty">
                                <div class="empty-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 19l7 -7l-7 -7" /><path d="M19 12H5" />
                                    </svg>
                                </div>
                                <p class="empty-title">Belum ada data surat keluar</p>
                                <p class="empty-subtitle text-secondary">
                                    Tambahkan surat keluar baru dengan klik tombol di atas
                                </p>
                            </div>
                        </td>
                    </tr>
