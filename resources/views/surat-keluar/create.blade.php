...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('surat-keluar.store') }}" method="POST" enctype="multipart/form-data" class="">
            @csrf
            <div class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="tujuan" class="form-control" value="{{ old('tujuan') }}" placeholder="Tujuan surat">
