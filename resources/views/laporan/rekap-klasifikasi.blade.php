            ...
            <form method="GET" action="{{ route('laporan.rekap-klasifikasi') }}">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-12 col-lg-6 ms-auto text-end">
                        <a href="{{ route('laporan.rekap-klasifikasi.excel', ['tahun' => $tahun]) }}" class="btn btn-success">
                        ...
                        <a href="{{ route('laporan.rekap-klasifikasi.pdf', ['tahun' => $tahun]) }}" class="btn btn-danger">
